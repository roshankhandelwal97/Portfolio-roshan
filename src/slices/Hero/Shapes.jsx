...
function Geometries() {
  ...
  const materials = [
    ...
    new THREE.MeshStandardMaterial({ color: 0x2ecc71, metalness: 0.7, roughness: 0 }),
    new THREE.MeshStandardMaterial({ color: 0xf1c40f, metalness: 0.5, roughness: 0.4 }),
    new THREE.MeshStandardMaterial({ color: 0xe74c3c, metalness: 0.9, roughness: 0.1 }),
    new THREE.MeshStandardMaterial({ color: 0x8e44ad, metalness: 1, roughness: 0.1 }),
    new THREE.MeshStandardMaterial({ color: 0x1abc9c, metalness: 0.6, roughness: 0.1 }),
