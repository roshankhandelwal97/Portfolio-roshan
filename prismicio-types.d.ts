...
/**
 * Item in *TechList → Default → Primary → Skills*
 */
export interface TechListSliceDefaultPrimarySkillsItem {
  /**
   * Tech Name field in *TechList → Default → Primary → Skills*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.skills[].tech_name
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  tech_name: prismic.KeyTextField;

  /**
   * Tech Color field in *TechList → Default → Primary → Skills*
   *
   * - **Field Type**: Color
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.skills[].tech_color
...
export interface TechListSliceDefaultPrimary {
  ...
  /**
   * Skills field in *TechList → Default → Primary*
   *
   * - **Field Type**: Group
   * - **Placeholder**: *None*
   * - **API ID Path**: tech_list.default.primary.skills[]
   * - **Documentation**: https://prismic.io/docs/field#group
   */
  skills: prismic.GroupField<Simplify<TechListSliceDefaultPrimarySkillsItem>>;
}
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      HeroSliceDefault,
      TechListSlice,
      TechListSliceDefaultPrimarySkillsItem,
